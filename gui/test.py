...
from PyQt5.QtWidgets import (QWidget, QApplication, QPushButton, QGridLayout, QVBoxLayout, QGroupBox, QToolTip,
...
class SerialQtTool(QWidget):
    ...
    def __init__(self):
        ...
        self.log_view_textBrowser.setFont(QFont('Helvetica', 12))  # 配置显示格式
    ...
    def timerEvent(self, e):
        ...
        if text_line:
            ...
            self.log_view_textBrowser.setText(text_line)  # 设置测试结果显示内容为测试成功
