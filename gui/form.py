...
class Ui_widget(object):
    ...
    def retranslateUi(self, widget):
        ...
        self.cbatcmd.setItemText(16, _translate("widget", "AT+VEHICLE_MODE="))
        self.cbatcmd.setItemText(17, _translate("widget", "AT+ALT_PARA=-9.1,37,1"))
        self.cbatcmd.setItemText(18, _translate("widget", "AT+LEVER_ARM=0.01,-0.027,-0.1"))
        self.cbatcmd.setItemText(19, _translate("widget", "AT+ACTIVATE_KEY="))
