...
class Ui_widget(object):
    def setupUi(self, widget):
        ...
        self.checkBox_savenmea.setGeometry(QtCore.QRect(298, 591, 77, 16))
        ...
        self.checkBox_ggafmt.setGeometry(QtCore.QRect(227, 591, 65, 16))
        ...
        self.checkBox_sendgga.setGeometry(QtCore.QRect(162, 591, 59, 16))
        ...
        self.checkBox_autoScoll.setGeometry(QtCore.QRect(381, 591, 83, 16))
    ...
    def retranslateUi(self, widget):
        ...
        widget.setWindowTitle(_translate("widget", "FMI Ntrip Serial Tool v1.1"))
        ...
        self.cbatcmd.setItemText(9, _translate("widget", "AT+GPGSA=UART1,"))
        self.cbatcmd.setItemText(10, _translate("widget", "AT+GPGSV=UART1,"))
        self.cbatcmd.setItemText(11, _translate("widget", "AT+GPGST=UART1,"))
        self.cbatcmd.setItemText(12, _translate("widget", "AT+GPZDA=UART1,"))
        self.cbatcmd.setItemText(13, _translate("widget", "AT+GPREF=UART1,"))
        self.cbatcmd.setItemText(14, _translate("widget", "AT+VEHICLE_MODE="))
        self.cbatcmd.setItemText(15, _translate("widget", "AT+ALT_PARA=-9.1,37,1"))
        self.cbatcmd.setItemText(16, _translate("widget", "AT+LEVER_ARM=0.01,-0.027,-0.1"))
