...
class Ui_widget(object):
    def setupUi(self, widget):
        ...
        self.Serial.setGeometry(QtCore.QRect(730, 10, 261, 231))
        ...
        self.checkBox_savenmea.setGeometry(QtCore.QRect(161, 591, 77, 16))
        ...
        self.checkBox_ggafmt.setGeometry(QtCore.QRect(309, 591, 65, 16))
        ...
        self.checkBox_sendgga.setGeometry(QtCore.QRect(244, 591, 59, 16))
    ...
    def retranslateUi(self, widget):
        ...
        self.cbatcmd.setItemText(7, _translate("widget", "AT+GPGGA=UART1,"))
        self.cbatcmd.setItemText(8, _translate("widget", "AT+GPGST=UART1,"))
        self.cbatcmd.setItemText(9, _translate("widget", "AT+GPZDA=UART1,"))
        self.cbatcmd.setItemText(10, _translate("widget", "AT+GPREF=UART1,"))
        self.cbatcmd.setItemText(11, _translate("widget", "AT+VEHICLE_MODE="))
        self.cbatcmd.setItemText(12, _translate("widget", "AT+ALT_PARA=-9.1,37,1"))
        self.cbatcmd.setItemText(13, _translate("widget", "AT+LEVER_ARM=0.01,-0.027,-0.1"))
