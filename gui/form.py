...
class Ui_widget(object):
    ...
    def retranslateUi(self, widget):
        ...
        widget.setWindowTitle(_translate("widget", "FMI Ntrip Serial Tool v1.3 (for any support please contact fmi@feyman.cn)"))
        ...
        self.cbatcmd.setItemText(7, _translate("widget", "AT+UPDATE_SHELL"))
        self.cbatcmd.setItemText(8, _translate("widget", "AT+SELF_TEST="))
        self.cbatcmd.setItemText(9, _translate("widget", "AT+GPGGA=UART1,"))
        ...
        self.cbatcmd.setItemText(16, _translate("widget", "AT+FMRPY=UART1,"))
        self.cbatcmd.setItemText(17, _translate("widget", "AT+ZUPT=ENABLE"))
        self.cbatcmd.setItemText(18, _translate("widget", "AT+DR_TIME=120"))
        self.cbatcmd.setItemText(19, _translate("widget", "AT+VEHICLE_MODE="))
        self.cbatcmd.setItemText(20, _translate("widget", "AT+ALT_PARA=-9.1,37,1"))
        self.cbatcmd.setItemText(21, _translate("widget", "AT+LEVER_ARM=0.01,-0.027,-0.1"))
        self.cbatcmd.setItemText(22, _translate("widget", "AT+ACTIVATE_KEY="))
